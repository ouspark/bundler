...
case object DomInput extends DomType("FromInput") {
  ...
  private val formMethodType =
    com.akkoid.Enum(CompName("Input"), Seq("get", "post"), "FormMethodType")
  private val formTarget = com.akkoid.Enum(CompName("Input"),
                                           Seq("_blank", "_self", "_parent", "_top", "framename"),
                                           "FormTarget")
  private val inputAutoComplete =
    com.akkoid.Enum(CompName("Input"), Seq("on", "off"), "AutoComplete")
  private val inputType = com.akkoid.Enum(
    CompName("Input"),
    Seq(
      "button",
      "checkbox",
  ...
  private val inputEncodingType = com.akkoid.Enum(
    CompName("Input"),
